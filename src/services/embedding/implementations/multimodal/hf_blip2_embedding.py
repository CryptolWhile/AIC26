...
from src.services.embedding.models.blip.blip2_model import Blip2Model

logger = logging.getLogger(__name__)
logger.setLevel(logging.INFO)


class HuggingFaceBLIP2Embedding(EmbeddingModel):
    """HuggingFace BLIP-2 based embedding model implementation."""
    ...
    def __init__(
        ...
        try:
            logger.info(f"Loading HuggingFace BLIP-2 model: {self.model_name}")
            self.model = Blip2Model.from_pretrained(self.model_name).to(self.device)
