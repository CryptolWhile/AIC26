...
from src.services.processing.shot_extraction.models.TransNetV2.inference.transnetv2 import TransNetV2
...
class TransNetV2Extractor(ShotExtractor):
    ...
    def get_method_name(cls) -> ExtractionMethod:
        return ExtractionMethod.TRANSNETV2
