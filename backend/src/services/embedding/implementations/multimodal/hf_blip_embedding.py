...
from src.services.embedding.models.blip.blip_model import BlipModel

logger = logging.getLogger(__name__)
logger.setLevel(logging.INFO)


class HuggingFaceBLIPEmbedding(EmbeddingModel):
    """HuggingFace BLIP based embedding model implementation."""
    
    def __init__(
        self,
        model_name: str = "Salesforce/blip-itm-large-flickr", 
        ...
        try:
            logger.info(f"Loading HuggingFace BLIP model: {self.model_name}")
